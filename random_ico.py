...
####################################################################
# Purpose: Create xyz files of icosahedral cluster consisting of 2 #
#          or two different atom types. The outer layer is         #
#          randomly occupied for a given ncore/nouter              #
####################################################################
#                Elke Fasshauer                                    #
####################################################################
...
# Anzahl der Kernatome fuer naechsten Schritt
nc_atoms = len(coords)
